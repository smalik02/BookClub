...
public class SignedRequestHelper {
    ...
    private String awsAccessKeyId = "AKIAJAD3UFO4LVUT3WNQ";
    private String awsSecretKey = "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";
    private String awsAssociatesTag = "booklub-20";
